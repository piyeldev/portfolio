<script>
    ...
    import accessKey from "/src/IMPORTANT_AND_DANGEROUS/access_key_web3forms.txt?raw";
</script>

<div class="sm:mt-[120px] mx-6">
	...
	<div class="bg-slate-100 p-4 pb-8 mt-5 w-[75%] rounded-xl">
		<form action="https://api.web3forms.com/submit" method="post">
            ...
            <div class="form-group-container flex flex-col gap-2 ml-1 mt-2">
                ...
                <div class="form-group">
                    ...
                    <input required class="form-input" id="email" name="email" type="text" placeholder="e.g someone@example.com"/>
                </div>
                <div class="form-group">
            ...
            <button type="submit" class="rounded-xl mt-8 ml-2 px-3 py-2 bg-[#2c436d] text-white">Send message</button>
		</form>
	</div>
    <div class="alternative flex flex-col items-center w-[75%]">
        <p>or</p>
        <div class="email-btn">
            <a href="mailto:frankthecrafter23@gmail.com" class="text-white bg-[#2c436d]">Message using your favorite email app</a>
        </div>
    </div>
</div>
...
<style lang="postcss">
    ...
    .form-input {
        @apply ml-1 px-2 pb-0.5 border-black border-[1px] rounded-xl;
    }
