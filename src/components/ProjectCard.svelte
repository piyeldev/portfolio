<script>
	...
	let backgroundColorOfTitle = $state("");
...
>
	...
	<div class=" flex md:flex-row flex-col mt-6">
		...
		<div class="md:flex hidden gap-4 ml-4 self-end">
			<a aria-label="website" target="_blank" href={link}><i class=" fa-solid fa-globe mt-8 text-white text-2xl"></i></a>
			<a aria-label="github repo" target="_blank" href={repo}><i class="fa-solid fa-code text-white text-2xl"></i></a>
		</div>
	</div>
	<div class="h-full flex items-end md:justify-start justify-end">
		...
		<div class="md:hidden flex gap-4 justify-end mr-2">
			<a aria-label="website" target="_blank" href={link}><i class=" fa-solid fa-globe text-white text-base"></i></a>
			<a aria-label="github repo" target="_blank" href={repo}><i class="fa-solid fa-code text-white text-base"></i></a>
		</div>
	</div>
</div>
